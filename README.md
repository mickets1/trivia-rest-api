This API provides the users(s) with the ability to request different kinds of trivia questions, It can for example be a random question from a specific category, answers randomized, random question from all of the categories and the ability for authenticated users to add, edit and delete questions.
